...
<jsp:useBean id="excursionTours" scope="session" type="java.util.Set"/>
    ...
    <div class="container top-container">
        <div class="row">
            <div class="col col-lg secNav">
                <form class="form-registration" action="controller?command=showexcursiondata" method="post">
                ...
                <div class="container-fluid mt-5" style="background-color: #eeeeee">
                    <div class="container p-5">
                        <div class="row justify-content-center">
                            <c:if test="${excursionTours.size() == 0}">
                                <div class="alert alert-warning" role="alert">
                                    <c:out value="${tourEx}"/>
                                </div>
                            </c:if>
                            <c:forEach items="${excursionTours}" var="excursionTour" >
                                <div class="col col-lg-4 description" >
                                    <div class="card text-center mt-5 description-container param">
                                        <img src="${excursionTour.imgPath}" alt="" class="card-img-top img">
                                        <c:if test="${excursionTour.status eq 'HOT'}">
                                            <span class="badge bg-danger"> ${excursionTour.status}</span>
                                        </c:if>
                                        <div class="card-body" >
                                            ...
                                            <h4 class="card-title" style="margin-top: 10px">
                                                <span class="badge rounded-pill bg-warning text-dark">${excursionTour.price} $</span>
                                            </h4>
                                        </div>
                                        <div class="card-footer">
                                            <a class="btn btn-outline-primary" id="${excursionTour.id}"
                                               href="controller?command=gotodetailspage&id=${excursionTour.id}">
